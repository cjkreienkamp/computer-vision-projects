...
flags.DEFINE_string("csv_input", os.path.join(project_dir,'annotations','test_labels.csv'), "Path to the CSV input")   # CHANGE THIS
flags.DEFINE_string("output_path", os.path.join(project_dir,'annotations','test.record'), "Path to output TFRecord")   # CHANGE THIS
flags.DEFINE_string(
    "label_map",
    os.path.join(project_dir,'annotations','label_map.pbtxt'),
...
# and so on.
flags.DEFINE_string("img_path", os.path.join(project_dir,'data','test'), "Path to images")     # CHANGE THIS
FLAGS = flags.FLAGS
